  ...
  return (
    <div>
      ...
      <main className="font-bodyFont">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-20 px-4 gap-3 md:gap-6 py-6">
          {posts.map((post) => (
            <Link href={`/post/${post.slug.current}`} key={post._id}>
              <div className="border-[1px] border-secondaryColor border-opacity-40 height-[450px] group">
